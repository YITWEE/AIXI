...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_number= (EditText) findViewById(R.id.et_login_name);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.bt_login_forgetpassword:
                Toast.makeText(LoginActivity.this,"对不起！！！ 现在无法解决",Toast.LENGTH_LONG).show();
                break;
            case R.id.bt_login_login:
                ...
                {
                    Toast.makeText(LoginActivity.this,"请输入你的账号和密码",Toast.LENGTH_LONG).show();
                    break;
                }
                numbertemp=sharedPreferences.getString(number," ");
                if(numbertemp==" ")
                {
                    Toast.makeText(LoginActivity.this, "该账号还未注册，请注册", Toast.LENGTH_LONG).show();
                    break;
                }
                else {
